function st = nufft_init_v2(om, Nd, Jd, Kd, varargin)
%|function st = nufft_init_v2(om, Nd, Jd, Kd, [n_shift,] ...)
%|
...
%| Change Log
%| JLH 12/5/2014: block_outer_sum and block_outer_prod changed to loops to
...
%st.p = MRFILSparse(M,prod(Kd),mm(:),kk(:),single(uu(:)));
% sparse object, to better handle single precision operations!
% Disabled due to poor performance - AMC 9/24/2017
