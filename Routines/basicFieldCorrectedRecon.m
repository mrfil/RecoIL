% Wrapper script to prepare a basic 2D or 3D reconstruction 
% Reconstructing 3D SMS requires reordering the sense maps and field maps
% which is not handled in this wrapper.
