...
% perform recon
img = phaseCorrectedReconMag(rInfoCC, senMBCC, maskMB, FMMB, PMaps, magErrors,'Niter',Niter,'L',L,'Rbeta',Rbeta,'dims2penalize',[1,1,0],'averagesToRecon',averagesToRecon,'repetitionsToRecon',repetitionsToRecon,'slicesToRecon',slicesToRecon);
