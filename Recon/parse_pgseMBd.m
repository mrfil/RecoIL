function obj = parse_pgseMBd(obj)
   ...
   [grads_mTm, FOVRef, FOVzRef, RUP, CenterOfKSpace] = readExternalGradFile([path '/trajectories/Rxy1Rz1Nxy96Nz4_InOut/Rxy1Rz1Nxy96Nz4_InOut.xml']);
   RUP
   ...
   %CenterOfKSpaceSample = floor(CenterOfKSpace*10E-6/obj.adcTsNav);
   ...
   obj.timingVecNav = (0:obj.adcTsNav:obj.adcTsNav*(length(obj.kReadNav(:,1))-1)) - CenterOfKSpace*10E-6;
