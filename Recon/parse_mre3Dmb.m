function obj = parse_mre3Dmb(obj)
   ...
   % email address:
   % Website:
   % May 2017; Last revision: 16-Sep-2017
   ...
   obj.multibandFactor = obj.DataObject.hdr.MeasYaps.sWipMemBlock.alFree{8};
   obj.nShotsDesigned = obj.DataObject.hdr.MeasYaps.sWipMemBlock.alFree{6};
   obj.nShotsUsed = obj.DataObject.hdr.MeasYaps.sWipMemBlock.alFree{7};
