function obj = parseSpiralInReadout(obj)

girfTs = 2E-6;
obj.readShift = obj.readShift;
...
Greado  = Greado(end:-1:1);
Gphaseo = Gphaseo(end:-1:1);
kreadi  = kreadi(end:-1:1);
kphasei = kphasei(end:-1:1);
